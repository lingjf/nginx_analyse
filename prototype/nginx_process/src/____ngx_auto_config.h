#define NGX_CONFIGURE " --without-http_rewrite_module --without-http_gzip_module --prefix=/media/sf_Proj/nginx_process/objs"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/media/sf_Proj/nginx_process/objs/"
#endif
...
#ifndef NGX_OLDPID_PATH
#define NGX_OLDPID_PATH  "logs/nginx.pid.old"
#endif
