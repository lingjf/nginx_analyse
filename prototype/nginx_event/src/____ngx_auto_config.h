#define NGX_CONFIGURE " --without-http_rewrite_module --without-http_gzip_module --prefix=/media/sf_Proj/nginx_analyse/objs"
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/media/sf_Proj/nginx_analyse/objs/"
#endif
