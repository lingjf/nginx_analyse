...
ngx_http_static_handler(ngx_http_request_t *r)
{
    ...
    printf("ngx_http_static_module : %s", jeff_http_request_tustring(r));
    printf("ngx_http_static_module : %s", jeff_http_core_loc_conf_tustring(ngx_http_get_module_loc_conf(r, ngx_http_core_module)));
    ...
    //printf("%s\n", jeff_open_file_cache_tustring(clcf->open_file_cache));
